report 25028389 "FA Disposal Act"
{
    WordLayout = './Objects/FA Disposal Act.docx';
    Caption = 'FA Disposal Act';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("FA Act Header"; "FA Act Header")
        {
            ...
            column(RespEmployeeName; "FA Act Header"."Old Responsible SP Name")
            {
            }
            column(RespEmployeeCode; "FA Act Header"."Old Responsible SP Code")
            {
            }
            column(RespEmployeeJobTitle; Employee2."Job Title")
            {
            }
            ...
            column(ReasonOfDisposal; ReasonOfDisposal)
            {
            }
            column(CommisionClosure; CommisionClosure)
            {
            }
            ...
            dataitem("FA Act Line"; "FA Act Line")
            {
                ...
                column(ProjectCode; FA."Global Dimension 1 Code")
                {
                }
                column(VehicleCode; FA."Global Dimension 2 Code")
                {
                }
                ...
                begin
                    ...
                    CALCFIELDS("FA Description", "FA Description 2");
            ...
            begin
                ...
                REPEAT
                    CommisionClosure += '_';
                UNTIL STRLEN(CommisionClosure) = 198;

                REPEAT
                    ReasonOfDisposal += '_';
                UNTIL STRLEN(ReasonOfDisposal) = 198;

                IF "FA Act Header"."Comission Closure" <> '' THEN
                    CommisionClosure := "FA Act Header"."Comission Closure";
                IF "FA Act Header"."Reason Of Disposal" <> '' THEN
                    ReasonOfDisposal := "FA Act Header"."Reason Of Disposal";
            end;
        }
    }
    ...
    var
        ...
        ReasonOfDisposal: Text;
        CommisionClosure: Text;
