report 25028387 "FA Inventory Act"
{
    WordLayout = './Objects/FA Inventory Act.docx';
    Caption = 'FA Inventory Act';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("FA Act Header"; "FA Act Header")
        {
            ...
            column(RespEmployeeName; "FA Act Header"."New Responsible SP Name")
            {
            }
            column(RespEmployeeCode; "FA Act Header"."New Responsible SP Code")
            {
            }
            column(R_EmployeeName; "FA Act Header"."Old Responsible SP Name")
            {
            }
            column(R_EmployeeCode; "FA Act Header"."Old Responsible SP Code")
            {
            }
            ...
            {
                DataItemTableView = ORDER(Ascending) WHERE(Number = CONST(1));
            ...
            begin
                ...
                IF "FA Act Header"."Warrant date" <> 0D THEN
                    WarrantDate := FORMAT("FA Act Header"."Warrant date", 0, '<Day,2>.<Month,2>.<Year4>');
            end;
        }
    }
